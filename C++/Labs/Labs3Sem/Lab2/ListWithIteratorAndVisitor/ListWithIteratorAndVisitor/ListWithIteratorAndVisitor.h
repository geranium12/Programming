...
{
public:
	virtual void visit(MyInt temp) = 0;
	//virtual void visit(MyDouble temp) = 0;
	//virtual void visit(MyString temp) = 0;
...
//class MyDouble : public Element
//{
//	double d;
//public:
//	MyDouble() { d = 0; }
//	MyDouble(int _d) { d = _d; }
//
//	bool operator == (MyDouble& temp)
//	{
...
public:
	void visit(MyInt temp) override
	{
		value += "MyInt";
		value += " ";
	}

	/*void visit(MyDouble temp) override
	{
		value += "MyDouble";
		value += " ";
	}

	void visit(MyString temp) override
	{
		value += "MyString";
		value += " ";
	}
